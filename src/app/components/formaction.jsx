...
const EmailSection = () => {
  ...
  return (
    ...
    >
      <div className="bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -right-4 transform -translate-x-1/2 -translate-1/2"></div>
      <div className="z-10">
