    ...
    <section className="text-white py-16 px-4 md:px-8 xl:px-16" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 xl:gap-16 items-center">
        <div className="rounded-lg overflow-hidden">
          <Image src="/images/about-image.jpeg" width={500} height={500} alt="hero image" />
        </div>
        <div className="mt-8 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold mb-4">About Me</h2>
          <p className="text-base lg:text-lg text-gray-300">
            a web developer who loves startups and making new connections.
            I also like to help others learn about new technologies. so if you
